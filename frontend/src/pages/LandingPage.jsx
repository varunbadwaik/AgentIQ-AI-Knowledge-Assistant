...
export default function LandingPage({ onNavigate }) {
    ...
    return (
        <div style={{ background: '#09090b', minHeight: '100vh', color: '#fafafa', fontFamily: "'Work Sans', system-ui, sans-serif", position: 'relative', scrollBehavior: 'smooth' }}>
            ...
            {/* =========== HERO =========== */}
            <main style={{ position: 'relative', zIndex: 10, paddingTop: '120px', paddingBottom: '80px', paddingLeft: '24px', paddingRight: '24px' }}>
                <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                    ...
                    <p style={{
                        fontSize: '18px', lineHeight: '1.6', color: '#71717a',
                ...
                <div style={{ marginTop: '80px', maxWidth: '1000px', marginLeft: 'auto', marginRight: 'auto', position: 'relative' }}>
                    <div style={{
                        ...
                        {/* Fake Dashboard */}
                        <div style={{ display: 'flex', height: '500px', borderRadius: '8px', overflow: 'hidden', border: '1px solid #27272a' }}>
                            {/* Sidebar */}
                            <div style={{ width: '200px', background: '#09090b', borderRight: '1px solid #27272a', padding: '16px' }}>
                            ...
                            {/* Main */}
                            <div style={{ flex: 1, background: '#09090b', padding: '40px' }}>
                                <div style={{ margin: '0 auto', maxWidth: '400px', textAlign: 'center' }}>
                                    <div style={{ fontSize: '24px', fontWeight: 600, color: '#fafafa', marginBottom: '8px' }}>Good morning, Human.</div>
            ...
            {/* =========== FEATURES =========== */}
            <section id="features" style={{ padding: '80px 24px', maxWidth: '1000px', margin: '0 auto', borderTop: '1px solid #27272a' }}>
                <div style={{ textAlign: 'center', marginBottom: '64px' }}>
                    <h2 style={{ fontSize: '30px', fontWeight: 600, marginBottom: '16px', letterSpacing: '-0.02em' }}>
                        Built for focus.
                    </h2>
