 ...
 * Updated to "Human/Pro" Monochrome Aesthetic.
 */
export default function AppSidebar({ activePage, onNavigate }) {
    ...
    return (
        <aside style={{
            width: '260px', minWidth: '260px', background: '#09090b', /* Zinc 950 */
            ...
            <div style={{ padding: '0 8px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                {navItems.map((item, i) => {
                    ...
                    return (
                        <button key={i} onClick={() => onNavigate(item.page)} style={{
                            display: 'flex', alignItems: 'center', gap: '10px',
                            padding: '8px 12px', borderRadius: '6px', border: 'none',
                            background: isActive ? '#f4f4f5' : 'transparent', /* Zinc 100 for active */
